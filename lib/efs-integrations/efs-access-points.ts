    ...
    constructor(
        ...
        */
        const accessPointConfigs: accessPointConfigType[] = [
            ...
            ...(createEcsOnEc2AccessPoints
                ? [{ name: "Ecs-Shared", posixId: 3000, path: "/shared/ecs" }]
                : []),
            ...(createEcsOnEc2AccessPoints
                ? [{ name: "Ecs-Private", posixId: 3000, path: "/private/ecs" }]
                : []),
            ...(createFargateAccessPoints
                ? [{ name: "Fargate-Shared", posixId: 7000, path: "/shared/fargate" }]
                : []),
            ...(createFargateAccessPoints
                ? [{ name: "Fargate-Private", posixId: 7000, path: "/private/fargate" }]
                : []),
        ];
